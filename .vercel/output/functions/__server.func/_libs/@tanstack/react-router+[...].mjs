...
function MatchView({ router, matchId, resetKey, matchState }) {
	...
	}), matchState.parentRouteId === "__root__" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(OnRendered, {}), router.options.scrollRestoration && true ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ScrollRestoration$1, {}) : null] }) : null] });
}
function OnRendered() {
	useRouter();
	return null;
...
//#endregion
export { resolveManifestCssLink as A, GLOBAL_TSR as C, getScriptPreloadAttrs as D, createInlineCssStyleAsset as E, isNotFound as F, createLRUCache as I, invariant as L, isRedirect as M, isResolvedRedirect as N, getStylesheetHref as O, rootRouteId as P, decodePath as R, useRouter as S, createInlineCssPlaceholderAsset as T, createRootRouteWithContext as _, replaceSsrResponse as a, Navigate as b, HeadContent as c, ScrollRestoration as d, RouterProvider as f, createFileRoute as g, lazyRouteComponent as h, normalizeSsrResponse as i, executeRewriteInput as j, resolveManifestAssetLink as k, useLocation as l, Outlet as m, defineHandlerCallback as n, stripSsrResponseBody as o, createRouter as p, isSsrResponse as r, Scripts as s, renderRouterToStream as t, useRouterState as u, Link as v, TSR_SCRIPT_BARRIER_ID as w, useNavigate as x, require_react_dom as y };

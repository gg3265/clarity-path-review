...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/server-BV3zf-NN.js
var server_BV3zf_NN_exports = /* @__PURE__ */ __exportAll({
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BIK3LiOi.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-dwDVHqyE.mjs").then((n) => n.t),
...
//#endregion
export { createServerEntry, server_default as default, createCsrfMiddleware as n, createMiddleware as r, server_BV3zf_NN_exports as t };

...
import { A as resolveManifestCssLink, D as getScriptPreloadAttrs, F as isNotFound, L as invariant, M as isRedirect, N as isResolvedRedirect, O as getStylesheetHref, P as rootRouteId, a as replaceSsrResponse, f as RouterProvider, i as normalizeSsrResponse, j as executeRewriteInput, k as resolveManifestAssetLink, n as defineHandlerCallback, o as stripSsrResponseBody, r as isSsrResponse, t as renderRouterToStream } from "../_libs/@tanstack/react-router+[...].mjs";
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/server-RqmYjlOX.js
var server_RqmYjlOX_exports = /* @__PURE__ */ __exportAll({
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BTwyL_qs.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Y1X9ZrKJ.mjs").then((n) => n.t),
...
//#endregion
export { createServerEntry, server_default as default, createCsrfMiddleware as n, createMiddleware as r, server_RqmYjlOX_exports as t };
